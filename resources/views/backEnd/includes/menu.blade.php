...
$urlAfterRoot = substr($fullPagePath, strpos($fullPagePath, 'BACKEND_PATH') + $envAdminCharCount);
?>
        ...
        <div flex class="hide-scroll">
            <nav class="scroll nav-active-primary">
                ...
                <ul class="nav" ui-nav>
                    ...
                    <li>
                        <a href="{{ url('adminHome') }}" onclick="location.href='{{ url('adminHome') }}'">
                    ...
                    <!-- govers -->
                    <li>
                        <a href="{{ route('govers') }}" onclick="location.href='{{ route('govers') }}'">
                            <span class="nav-icon"><i class="fa fa-globe"></i></span>
                            <span class="nav-text">{{ trans('backLang.govers') }}</span>
                        </a>
                    </li>

                    <!-- degree -->
                    <li>
                        <a href="{{ route('degrees') }}" onclick="location.href='{{ route('degrees') }}'">
                            <span class="nav-icon"><i class="fa fa-signal"></i></span>
                            <span class="nav-text">{{ trans('backLang.degrees') }}</span>
                        </a>
                    </li>

                    <!-- type -->
                    <li>
                        <a href="{{ route('types') }}" onclick="location.href='{{ route('types') }}'">
                            <span class="nav-icon"><i class="fa fa-sitemap"></i></span>
                            <span class="nav-text">{{ trans('backLang.type') }}</span>
                        </a>
                    </li>

                    <!-- court -->
                    <li>
                        <a href="{{ route('courts') }}" onclick="location.href='{{ route('courts') }}'">
                            <span class="nav-icon"><i class="fa fa-building"></i></span>
                            <span class="nav-text">{{ trans('backLang.court') }}</span>
                        </a>
                    </li>

                    <!-- circle -->
                    <li>
                        <a href="{{ route('circles') }}" onclick="location.href='{{ route('circles') }}'">
                            <span class="nav-icon"><i class="fa fa-circle-thin"></i></span>
                            <span class="nav-text">{{ trans('backLang.circle') }}</span>
                        </a>
                    </li>

                    <li class="nav-header hidden-folded">
                        <small class="text-muted">{{ trans('backLang.clientsData') }}</small>
                    </li>

                    <li>
                        <a href="{{ route('clients') }}">
                            <span class="nav-icon"><i class="material-icons">&#xe7ef;</i></span>
                            <span class="nav-text">{{ trans('backLang.clients') }}</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('agents') }}">
                            <span class="nav-icon"><i class="material-icons">directions_bike</i></span>
                            <span class="nav-text">{{ trans('backLang.agents') }}</span>
                        </a>
                    </li>

                    <li>
                        <a href="javascript:void(0)">
                            <span class="nav-icon"><i class="material-icons">notifications</i></span>
                            <span class="nav-text">{{ trans('backLang.notifications') }}</span>
                        </a>
                    </li>

                    <li>
                        <a href="javascript:void(0)">
                            <span class="nav-icon"><i class="material-icons">local_atm</i></span>
                            <span class="nav-text">{{ trans('backLang.payments') }}</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-header hidden-folded">
                        <small class="text-muted">{{ trans('backLang.requestData') }}</small>
                    </li>

                    <li>
                        <a href="{{ route('requests', 'new') }}">
                            <span class="nav-icon"><i class="fa fa-bolt"></i></span>
                            <span class="nav-text">{{ trans('backLang.newRequests') }}</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('requests', 'pending') }}">
                            ...
                            <span class="nav-text">{{ trans('backLang.pendingRequests') }}</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('requests', 'done') }}">
                            <span class="nav-icon"><i class="fa fa-check"></i></span>
                            <span class="nav-text">{{ trans('backLang.doneRequests') }}</span>
                        </a>
                    </li>
