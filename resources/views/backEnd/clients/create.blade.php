    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">&#xe02e;</i> {{ trans('backLang.topicNew') }} {!! trans('backLang.clients') !!}</h3>
                <small>
            ...
            <div class="box-body">
                {{Form::open(['route'=>['clients.save'],'method'=>'POST', 'files' => true ])}}
                ...
                <div class="form-group row">
                    <label for="name" class="col-sm-2 form-control-label">{!!  trans('backLang.clientName') !!}</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label for="mobile" class="col-sm-2 form-control-label">{!!  trans('backLang.clientMobile') !!}</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label for="password" class="col-sm-2 form-control-label">{!!  trans('backLang.clientPassword') !!}</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row m-t-md">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a href="{{ route('clients') }}" class="btn btn-default m-t"><i class="material-icons">&#xe5cd;</i> {!! trans('backLang.cancel') !!}</a>
                    </div>
                </div>
