    ...
    @if(Helper::GeneralSiteSettings("style_footer")==1)
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="widget">
                        <h4 class="widgetheading"><i class="fa fa-android"></i> <i class="fa fa-apple"></i> &nbsp; Avogenda App</h4>
                        <button style="width: 100%;margin-bottom: 5px;" class="btn btn-success"><i class="fa fa-android fa-3x"></i><br><br>Android Application</button>
                        <button style="width: 100%" class="btn btn-success"><i class="fa fa-apple fa-3x"></i><br><br>iOS Application</button>
                    </div>
                </div>
