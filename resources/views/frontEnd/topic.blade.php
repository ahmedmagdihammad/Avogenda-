            ...
            <div class="row">
                <div class="col-lg-{{(count($Categories)>0)? "8":"12"}}">
                    ...
                    <article>
                        ...
                        <div class="bottom-article" style="display: none;">
                            <ul class="meta-post">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="bottom-article newcomment">
                                            ...
                                            <div class="form-group" style="display: none;">
                                                {!! Form::number('order_qty',"1", array('placeholder' => trans('frontLang.quantity'), 'class' => 'form-control','id'=>'order_qty', 'data-msg'=> trans('frontLang.yourQuantity'),'data-rule'=>'minlen:1','min'=>'1')) !!}
                                                <div class="validation"></div>
                                            </div>
                                            <div class="form-group">
