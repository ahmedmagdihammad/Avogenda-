...
Route::Group(['prefix' => env('BACKEND_PATH'), 'middleware' => ['auth']], function () {
    ...
    // Avogenda Govers
    Route::get('/govers', 'GoverController@index')->name('govers');
    Route::get('/govers/create', 'GoverController@create')->name('govers.create');
    Route::post('/govers/save', 'GoverController@save')->name('govers.save');
    Route::post('/govers/{id}/edit', 'GoverController@edit')->name('govers.edit');
    Route::post('/govers/{id}/delete', 'GoverController@delete')->name('govers.delete');

    // Avogenda Degrees
    Route::get('/degrees', 'DegreeController@index')->name('degrees');
    Route::get('/degrees/create', 'DegreeController@create')->name('degrees.create');
    Route::post('/degrees/save', 'DegreeController@save')->name('degrees.save');
    Route::post('/degrees/{id}/edit', 'DegreeController@edit')->name('degrees.edit');
    Route::post('/degrees/{id}/delete', 'DegreeController@delete')->name('degrees.delete');

    // Avogenda Types
    Route::get('/types', 'TypeController@index')->name('types');
    Route::get('/types/create', 'TypeController@create')->name('types.create');
    Route::post('/types/save', 'TypeController@save')->name('types.save');
    Route::post('/types/{id}/edit', 'TypeController@edit')->name('types.edit');
    Route::post('/types/{id}/delete', 'TypeController@delete')->name('types.delete');
    Route::get('/types/getDegrees', 'TypeController@getDegrees')->name('types.getDegrees');

    // Avogenda Courts
    Route::get('/courts', 'CourtController@index')->name('courts');
    Route::get('/courts/create', 'CourtController@create')->name('courts.create');
    Route::post('/courts/save', 'CourtController@save')->name('courts.save');
    Route::post('/courts/{id}/edit', 'CourtController@edit')->name('courts.edit');
    Route::post('/courts/{id}/delete', 'CourtController@delete')->name('courts.delete');
    Route::get('/courts/getDegrees', 'CourtController@getDegrees')->name('courts.getDegrees');
    Route::get('/courts/getTypes', 'CourtController@getTypes')->name('courts.getTypes');

    // Avogenda Circles
    Route::get('/circles', 'CircleController@index')->name('circles');
    Route::get('/circles/create', 'CircleController@create')->name('circles.create');
    Route::post('/circles/save', 'CircleController@save')->name('circles.save');
    Route::post('/circles/{id}/edit', 'CircleController@edit')->name('circles.edit');
    Route::post('/circles/{id}/delete', 'CircleController@delete')->name('circles.delete');
    Route::get('/circles/getDegrees', 'CircleController@getDegrees')->name('circles.getDegrees');
    Route::get('/circles/getTypes', 'CircleController@getTypes')->name('circles.getTypes');
    Route::get('/circles/getCourts', 'CircleController@getCourts')->name('circles.getCourts');

    // Avogenda Clients
    Route::get('/clients', 'ClientController@index')->name('clients');
    Route::get('/clients/create', 'ClientController@create')->name('clients.create');
    Route::post('/clients/save', 'ClientController@save')->name('clients.save');
    Route::post('/clients/{id}/edit', 'ClientController@edit')->name('clients.edit');
    Route::post('/clients/{id}/delete', 'ClientController@delete')->name('clients.delete');

    // Avogenda Agents
    Route::get('/agents', 'AgentController@index')->name('agents');
    Route::get('/agents/create', 'AgentController@create')->name('agents.create');
    Route::post('/agents/save', 'AgentController@save')->name('agents.save');
    Route::post('/agents/{id}/edit', 'AgentController@edit')->name('agents.edit');
    Route::post('/agents/{id}/delete', 'AgentController@delete')->name('agents.delete');

    // Avogenda Requests
    Route::get('/requests/{status}', 'RequestController@index')->name('requests');
    Route::get('/requests/create', 'RequestController@create')->name('requests.create');
    Route::post('/requests/{id}/edit', 'RequestController@edit')->name('requests.edit');
    Route::post('/requests/{id}/delete', 'RequestController@delete')->name('requests.delete');
    ...
    Route::get('/cache-clear', function () {
        ...
        return redirect()->url('adminHome')->with('doneMessage', trans('backLang.cashClearDone'));
    })->name('cacheClear');
});
